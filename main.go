...
func main() {
	mode := flag.String("mode", "run", "execution mode: run, batch, serve, fetch-prices, calc-rs, export-json, fetch-tdnet, parse-tanshin, debug-tanshin, import-jpx, detect-alerts, or test-parse")
